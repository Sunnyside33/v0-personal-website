...
export const metadata: Metadata = {
  title: "Contacts",
  description: "Get in touch with Sunnysid33. Find all my social media links and ways to connect.",
};
...
function ContactLink({ href, platform, username, icon }: ContactLinkProps) {
  return (
    <a
      href={href}
      target="_blank"
      rel="noopener noreferrer"
      className="flex items-center gap-4 p-4 rounded-xl border border-border bg-card hover:border-primary/50 hover:shadow-md transition-all duration-300 group"
    >
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      <header className="text-center mb-12">
        <FriedEggAvatar className="w-24 h-24 mx-auto mb-6" />
